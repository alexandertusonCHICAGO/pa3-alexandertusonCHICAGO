...
/* package vigenere-0.1.0.0 */
#ifndef VERSION_vigenere
#define VERSION_vigenere "0.1.0.0"
#endif /* VERSION_vigenere */
#ifndef MIN_VERSION_vigenere
#define MIN_VERSION_vigenere(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_vigenere */
...
#define CURRENT_COMPONENT_ID "vigenere-0.1.0.0-inplace-vigenere"
